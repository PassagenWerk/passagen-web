...
- Persisted generated citations across restarts and added explicit citation refresh with saved-state
  visibility and safe retention of previously authoritative content.
...
- Removed deleted papers from the actionable failed-paper retry list while preserving their
  failures in historical processing run details.
